...
<h3>Настройки Авторизации</h3>
	<input type="text" name="loginUI" placeholder="Введите Логин"><br>
	<input type="text" name="passUI" placeholder="Введите Пароль">
    <br>
...
void SP_handleConnect() {
  ...
  strcpy(portalCfg.loginUI, _SP_server.arg("loginUI").c_str());
  strcpy(portalCfg.passUI, _SP_server.arg("passUI").c_str());
